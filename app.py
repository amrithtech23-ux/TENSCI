...
.stButton > button {
    ...
    border: 4px solid #000000 !important; /* Matching text area border */
    text-align: center !important;
    padding: 8px 24px !important;
}

/* Button Hover Effect - Darker Blue */
...
def search_topics(query, topics):
    ...
    for topic in topics:
        ...
        if query_lower in topic_search_text:
            phrase_boost = 100  # Highest boost for exact phrase match
        ...
        total_score = phrase_boost + (words_found * 5) + multi_word_bonus
...
3. Use formal academic language suitable for Tamil Nadu State Board 10th standard students.
4. Provide definition, formulas, and examples clearly.
5. Avoid using LaTeX formatting or special characters."""
